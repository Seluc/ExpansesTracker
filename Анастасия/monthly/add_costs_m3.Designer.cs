namespace GroupProj.Анастасия.monthly
{
  partial class add_costs_m3
  {
    ...
    private void InitializeComponent()
    {
      ...
      // coments
      // 
      this.coments.Location = new System.Drawing.Point(13, 131);
      ...
      this.Name = "add_costs_m3";
      this.Text = "добавить месячный рассход";
