namespace GroupProj.Анастасия
{
  partial class add_costs_m2
  {
    ...
    private void InitializeComponent()
    {
      ...
      // summ
      // 
      this.summ.Location = new System.Drawing.Point(13, 44);
      ...
      // coments
      // 
      this.coments.Location = new System.Drawing.Point(13, 130);
      ...
      this.Name = "add_costs_m2";
      this.Text = "добавить месячный доход";
      this.Load += new System.EventHandler(this.add_cost_m2_Load);
