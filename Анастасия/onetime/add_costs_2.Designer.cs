namespace GroupProj.Анастасия
{
  partial class add_costs_2
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = "add_costs_2";
      this.Text = "добавить одноразовый доход";
